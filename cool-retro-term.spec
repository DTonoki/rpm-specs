...
%changelog
* Fri Nov 10 2017 tonoki@osstech.co.jp
- add Build Requires for Fedora25.

* Sun Sep 7 2014 - kamikazow@web.de
...
* Fri Aug 29 2014 - kamikazow@web.de
- Fixed: QtDeclarative-devel is required for "qmlscene" binary

* Fri Aug 1 2014 - kamikazow@web.de
- First build
- cool-old-term 0.9
